...
New-Item -Type SymbolicLink -Path ~/AppData/Local/Packages/Microsoft.WindowsTerminal_8wekyb3d8bbwe/LocalState/settings.json -Value $(Join-Path $PSScriptRoot WindowsTerminal/settings.json)
